...
export class AiAttackBehavior {
  ...
  private getAttackStrategies(
    ...
    switch (difficulty) {
      ...
      case Difficulty.Hard:
        ...
        // prettier-ignore
        return [bots, retaliate, assist, betray, nuked, traitor, afk, bounty, hated, veryWeak, juicy, victim, weakest, island, donate];
      case Difficulty.Impossible:
        // prettier-ignore
        return [retaliate, bots, veryWeak, assist, traitor, bounty, afk, betray, victim, juicy, nuked, hated, weakest, island, donate];
      default:
  ...
  maybePlaceBounty(): void {
    ...
    const surplus = this.player.gold() - AiAttackBehavior.BOUNTY_KEEP_RESERVE;
